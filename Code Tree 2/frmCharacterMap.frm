...
Private Sub cmdInsert_Click()
    ...
    Select Case LCase(frmMain.tbsView.SelectedItem.Key)
        Case "code"
            frmMain.rtfCode.SelText = txtChars.Text
        Case "notes"
            frmMain.rtfNotes.SelText = txtChars.Text
        Case Else
            Exit Sub
    End Select
End Sub
...
Private Sub Form_Load()
    On Local Error Resume Next
    'Toolbar button is presses in main form
    frmMain.tbrFormatting.Buttons("Character Map").Value = tbrPressed
...
Private Sub Form_Unload(Cancel As Integer)
    On Local Error Resume Next
    frmMain.tbrFormatting.Buttons("Character Map").Value = tbrUnpressed
